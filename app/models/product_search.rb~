...
class ProductSearch < Tableless
 # has_many :categories
  ...
  column :words_number_gte, :integer
  column :auction_minimum_days_until_end_of_auction, :integer
  column :auction_maximum_days_until_end_of_auction, :integer
  column :product_type, :string
  column :auction_current_price_gte, :decimal, :precision => 14, :scale =>4
  column :auction_current_price_lte, :decimal, :precision => 14, :scale =>4
